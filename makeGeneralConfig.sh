...
echo "# ./makeGeneralConfig.sh $CONFIGNAME --procMods $PROCMODIFIERS --custom$CUSTOMIZE" | cat - temp_cfg.py > temp && mv temp temp_cfg.py
...
python3 scripts/modifyGeneralConfig.py "temp_cfg.py" ${CONFIGNAME} -c temp_custom.py
