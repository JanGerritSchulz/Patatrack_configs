...
# ./makeTrackingConfig.sh PatatrackIT+3OT_clean4_UntilSharedHitCut_allTracks --procMods phase2CAExtension,singleIterPatatrack --custom addNonHPPixelTracksToMTV allTracks disableTripletCleaner
#
...
CONFIGNAME = "PatatrackIT+3OT_clean4_UntilSharedHitCut_allTracks"
