...
# ./makeTrackingConfig.sh PatatrackIT+3OT_clean0_NoCleaning_allTracks --procMods phase2CAExtension,singleIterPatatrack --custom addNonHPPixelTracksToMTV allTracks disableTripletCleaner disableSharedHitCut disableFastDuplicateRemover disableEarlyDuplicateRemover disableEarlyFishbone
#
...
CONFIGNAME = "PatatrackIT+3OT_clean0_NoCleaning_allTracks"
...
process.hltPhase2PixelTracksSoA.maxNumberOfTuples = cms.string(str(20*60*1024))
