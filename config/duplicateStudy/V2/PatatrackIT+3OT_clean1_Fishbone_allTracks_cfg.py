...
# ./makeTrackingConfig.sh duplicateStudy/V2/PatatrackIT+3OT_clean1_Fishbone_allTracks --procMods phase2CAExtension,singleIterPatatrack --custom maxEff caDCurvCutV9 fishboneV1 addNonHPPixelTracksToMTV allTracks disableTripletCleaner disableSharedHitCut disableFastDuplicateRemover disableEarlyDuplicateRemover
#
...
CONFIGNAME = "duplicateStudy/V2/PatatrackIT+3OT_clean1_Fishbone_allTracks"
...
# set the fishbone thresholds for merging doublets
# looser alignment requirement for barrel
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[1] = 0.99997
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[2] = 0.99998
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[3] = 0.9999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[28] = 0.9999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[29] = 0.9999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[30] = 0.9999
# unchanged for close endcap
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[4] = 0.99999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[16] = 0.99999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[5] = 0.99999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[17] = 0.99999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[6] = 0.99999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[18] = 0.99999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[7] = 0.99999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[19] = 0.99999
# stricter alignment requirement for far endcaps
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[8] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[20] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[9] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[21] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[10] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[22] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[11] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[23] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[12] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[24] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[13] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[25] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[14] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[26] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[15] = 0.999999
process.hltPhase2PixelTracksSoA.geometry.fishboneCuts[27] = 0.999999
