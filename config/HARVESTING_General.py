...
# with command line options: HARVEST -s HARVESTING:@hltValidation --conditions auto:phase2_realistic_T35 --mc --geometry ExtendedRun4D110 --scenario pp --filetype DQM --era Phase2C17I13M9 -n -1 --dirin results --filein file:General_DQMIO.root --no_exec
...
process.source = cms.Source("DQMRootSource",
    fileNames = cms.untracked.vstring('file:General_DQMIO.root')
)
